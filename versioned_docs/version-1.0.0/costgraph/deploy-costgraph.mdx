...
<details>
<summary><strong>Existing Prometheus installations</strong></summary>
...
:::caution[Postgres Configuration]
...
> **NOTE:** This will create a StatefulSet for the database instance and does not directly configure a PVC for the database.
...
import PrometheusImage from "@site/static/video/prometheus.gif";

import GrafanaShowcase from "@site/static/video/grafana.gif";
...
<Tabs>
    <TabItem value="dashboard" label="Accessing Superset">
      ...
      ### Accessing the dashboard 
        ...
        <Tabs>
            ...
            <TabItem value="ingress" label="Ingress">
                ...
                :::tip[Ingress Annotations]
                For users for traefik version 35.0.0 and below you will need to add the following annotations to the ingress resource:
    ...
    <TabItem value="prometheus" label="Prometheus Metrics">
        ...
        :::note[Exposing Prmetheus Metrics]
        ...
        > NOTE: If you installed prometheus-server using this guide, you have auto-discovery enabled by default for kubernetes services.
        ...
        <img src={PrometheusImage} alt="Prometheus Metrics"  />
    </TabItem>
    <TabItem value="grafana" label="Grafana Dashboard">
        Once you have the operator running, you can install the Grafana dashboard to view the metrics in a more user-friendly format. The Grafana dashboard is available in the [costgraph-manifests](https://github.com/baselinehq/costgraph-operator-manifests) repository.


        <img src={GrafanaShowcase} alt="Grafana using Prometheus metrics"  />
